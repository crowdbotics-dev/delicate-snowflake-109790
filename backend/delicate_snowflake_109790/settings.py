"""
Django settings for delicate_snowflake_109790 project.
...
ROOT_URLCONF = 'delicate_snowflake_109790.urls'
...
WSGI_APPLICATION = 'delicate_snowflake_109790.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_snowflake_109790 API",
    "DESCRIPTION": "API documentation for delicate_snowflake_109790 App",
    "VERSION": "v1",
}
